...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--search', default='factures', type=str, help='search term')
    parser.add_argument('-d', '--directory', default='/home/yassine/PycharmProjects/scrapping_ful_images', type=str, help='save directory')
    args = parser.parse_args()
    driver = webdriver.Chrome('/home/yassine/chromedriver')
